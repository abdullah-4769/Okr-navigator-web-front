...
// ✅ SAVE KEY RESULTS FOR LATER USE
  ...
  String _formatKeyResults(List<KeyResult> keyResults) {
    return keyResults.map((kr) {
      final title = (kr.title == null || kr.title == 'null') ? '' : kr.title!.tr;
      final description = (kr.description == null || kr.description == 'null')
          ? '' : kr.description!.tr;
      // If title is empty, just send description alone
