...
abstract class StrategyApi {
  ...
  /// 3. Submit Final Team Score
  @POST('/final-team-score')
  Future<dynamic> submitFinalTeamScore(@Body() Map<String, dynamic> body);

  /// 4. Get Final Team Score Summary
  @GET('/final-team-score/{teamId}/summary')
  Future<dynamic> getFinalTeamScoreSummary(@Path('teamId') int teamId);

  /// 5. Get User Final Score in Team
  @GET('/final-team-score/{teamId}/user/{userId}/score')
  Future<dynamic> getUserFinalScoreInTeam(
      @Path('teamId') int teamId,
      @Path('userId') String userId,
      );

  /// 6. Get Team Rewards Summary
  @GET('/final-team-score/team/{teamId}/rewards-summary')
  Future<dynamic> getTeamRewardsSummary(@Path('teamId') int teamId);
}