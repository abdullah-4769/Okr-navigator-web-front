...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    super.initState();
    // Initialize your existing LoginController
    controller = Get.put(LoginController(), permanent: false);
  }

  @override
  void dispose() {
    // Dispose controller only if registered
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          return isMobile
              ...
              : _buildWebDesktopLayout(context, constraints);
        },
      ),
    );
  }
  ...
  Widget _buildWebDesktopLayout(BuildContext context, BoxConstraints constraints) {
    ...
    cardWidth = cardWidth.clamp(300, 500);
    double cardHeight = constraints.maxHeight * 0.75;
    cardHeight = cardHeight.clamp(400, 600);
    double padding = constraints.maxWidth > 1200 ? 32 : 24;
  ...
  Widget _buildWebTextField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFF2E5BBA), width: 2)),
        errorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFFDC2626), width: 1)),
      ...
      child: ElevatedButton(
        ...
        child: isLoading
          ...
          child: const CircularProgressIndicator(
            ...
            : Text(
          text,
          style: TextStyle(fontSize: height * 0.32, fontWeight: FontWeight.w600),
        ),
      ),
    );
  }
