...
class LanguageScreen extends StatelessWidget {
  ...
  Widget _buildLanguageTile(
      ...
      Obx(() {
        // Fix this comparison - compare with language code
        final isSelected = controller.selectedLanguage.value.code == languageCode;
        ...
        return Container(
          ...
          child: ListTile(
            ...
            onTap: () => controller.changeLanguageByCode(languageCode), // 🔥 FIXED: Use the new helper method
          ),
        );
      });
