    ...
    return Stack(
      ...
      children: [
        ...
        Positioned(
          ...
          right: 150.w,
          child: Obx(() {
            final String imagePath = gameModeController.modeSvg.value;
            return CustomSvg(
              assetPath: imagePath,
    ...
    return Stack(
      ...
      children: [
        ...
        Positioned(
          ...
          child: Center(
            child: Obx(() {
              final String imagePath = gameModeController.modePng.value;
              return Container(
                height: 100,
                width: 100,
                decoration: BoxDecoration(
                ...
                child: ClipRRect(
                  ...
                  child: Image.asset(
                    ...
                    errorBuilder: (context, error, stackTrace) {
                      return CustomSvg(
                        assetPath: gameModeController.modeSvg.value,
